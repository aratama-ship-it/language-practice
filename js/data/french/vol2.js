// Vol.F2 基礎総合（フランス語・仏検4級軸＋3級要素）。2026-07-04 新規作成。
SUBJECTS.french.vols[2] = {
  label: "Vol.F2 基礎総合",
  passages: [
    {
      id: "f2-p1", vol: 2, part: 6,
      title: "第21〜24問：次のお知らせを読んでください。",
      body: "AVIS AUX HABITANTS\n\nLa bibliothèque municipale sera ---[Q21]--- du 3 au 10 août pour des travaux.\n\nPendant ---[Q22]--- période, il ne sera pas possible d'emprunter ou de rendre des livres. Les documents empruntés avant le 3 août pourront être rendus ---[Q23]--- le 15 août sans pénalité.\n\nNous vous ---[Q24]--- de votre compréhension.\n\nLa Mairie"
    },
    {
      id: "f2-p2", vol: 2, part: 7,
      title: "第25〜28問：次のメールを読んでください。",
      body: "De : marc.durand@courriel.fr\nÀ : service-client@voyages-soleil.fr\nObjet : Réservation annulée\n\nBonjour,\n\nJ'ai réservé un voyage pour Nice le 12 septembre (réservation n° 4587). Malheureusement, je dois annuler ce voyage parce que je suis malade.\n\nEst-il possible d'être remboursé, ou de reporter le voyage à une autre date ? Je préférerais partir en octobre si c'est possible.\n\nPouvez-vous me répondre avant vendredi, s'il vous plaît ? Je vous remercie d'avance.\n\nCordialement,\nMarc Durand"
    },
    {
      id: "f2-p3", vol: 2, part: 7,
      title: "第29〜32問：次の文章を読んでください。",
      body: "Thomas est un jeune cuisinier de vingt-huit ans. Il a ouvert son restaurant il y a deux ans, dans un petit village près de Bordeaux. Au début, il n'y avait pas beaucoup de clients, mais aujourd'hui le restaurant est souvent complet.\n\nThomas utilise seulement des produits de la région. Chaque matin, il va au marché pour choisir des légumes frais. Il dit que la qualité des ingrédients est le plus important.\n\nLe soir, quand le restaurant ferme, Thomas est fatigué mais heureux. Son rêve est d'écrire un livre de cuisine pour partager ses recettes."
    }
  ],
  questions: [
    {
    ...
    {
      id: "f2-q4", vol: 2, part: 5, passageId: null, number: 4,
      question: "Je n'ai pas ------- argent sur moi aujourd'hui.",
      choices: ["de l'", "d'", "du", "des"],
      answer: 1,
      explanation: "否定文では部分冠詞は de に。母音の前で d'。ne...pas d'argent。",
      category: "冠詞・限定詞"
    },
    {
      id: "f2-q5", vol: 2, part: 5, passageId: null, number: 5,
      question: "Tu as parlé à Sophie ? — Oui, je ------- ai parlé hier.",
      choices: ["la", "lui", "le", "l'"],
      answer: 1,
      explanation: "parler à quelqu'un（人に話す）は間接目的。Sophie を受ける間接目的代名詞は lui。je lui ai parlé。",
      category: "代名詞"
    },
    {
    ...
    {
      id: "f2-q7", vol: 2, part: 5, passageId: null, number: 7,
      question: "Il y a beaucoup ------- monde dans le magasin aujourd'hui.",
      choices: ["de", "du", "des", "le"],
      answer: 0,
      explanation: "数量表現 beaucoup de + 名詞（無冠詞）。beaucoup de monde =「たくさんの人」。",
      category: "冠詞・限定詞"
    },
    {
    ...
    {
      id: "f2-q10", vol: 2, part: 5, passageId: null, number: 10,
      question: "Elle porte une jolie jupe ------- .",
      choices: ["blanc", "blanche", "blancs", "blanches"],
      answer: 1,
      explanation: "jupe は女性単数。色形容詞 blanc の女性単数形は blanche。une jupe blanche。",
      category: "性数一致"
    },
    {
    ...
    {
      id: "f2-q13", vol: 2, part: 5, passageId: null, number: 13,
      question: "Il faut ------- tôt pour prendre le premier train.",
      choices: ["se lever", "se lève", "levé", "se levant"],
      answer: 0,
      explanation: "Il faut + 不定詞 =「〜しなければならない」。代名動詞は不定詞 se lever のまま。Il faut se lever tôt。",
      category: "動詞の活用"
    },
    {
      id: "f2-q14", vol: 2, part: 5, passageId: null, number: 14,
      question: "Ce sont ------- amis. Je les connais depuis longtemps.",
      choices: ["mon", "ma", "mes", "mon les"],
      answer: 2,
      explanation: "amis は複数名詞。所有形容詞「私の」の複数形は mes。mes amis。",
      category: "冠詞・限定詞"
    },
    {
    ...
    {
      id: "f2-q20", vol: 2, part: 5, passageId: null, number: 20,
      question: "Il pleut. Prends ------- parapluie !",
      choices: ["un", "une", "des", "de"],
      answer: 0,
      explanation: "parapluie は男性名詞、数えられる1本なので不定冠詞 un。un parapluie。",
      category: "冠詞・限定詞"
    },
    {
    ...
    {
      id: "f2-q22", vol: 2, part: 6, passageId: "f2-p1", number: 22,
      question: "---[Q22]--- に入るものを選んでください。",
      choices: ["cette", "ce", "ces", "cet"],
      answer: 0,
      explanation: "période は女性単数名詞。指示形容詞の女性単数形は cette。cette période =「この期間」。",
      category: "冠詞・限定詞"
    },
    {
    ...
    {
      id: "f2-q27", vol: 2, part: 7, passageId: "f2-p2", number: 27,
      question: "Qu'est-ce que Marc préférerait faire ?",
      choices: ["Partir en octobre", "Partir en août", "Aller à Bordeaux", "Annuler définitivement"],
      answer: 0,
      explanation: "本文：\"Je préférerais partir en octobre si c'est possible\"（可能なら10月に出発したい）。",
      category: "読解"
    },
    {
    ...
    {
      id: "f2-q30", vol: 2, part: 7, passageId: "f2-p3", number: 30,
      question: "Que fait Thomas chaque matin ?",
      choices: ["Il écrit un livre", "Il va au marché", "Il se repose", "Il ferme le restaurant"],
      answer: 1,
      explanation: "本文：\"Chaque matin, il va au marché pour choisir des légumes frais\"（毎朝、市場で新鮮な野菜を選ぶ）。",
      category: "読解"
    },
    {
